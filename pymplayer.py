...
class MusicPlayer:
    ...
    def _get_volume(self):
        return MusicPlayer.main_mixer.music.get_volume()
    ...
    def _cut(self, starting_p, ending_p, filePathAndName):
    ...
    def _sound_to_array(self, filePath = sound_path):
        command = [ "ffmpeg", '-i', filePath, '-f',
        's16le', '-acodec', 'pcm_s16le', '-ar', '44100', '-ac', '2', '-']
